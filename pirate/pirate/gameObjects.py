...
class Level(object):
	...
	def render(self,width,height):
		...
		ship = Icon(0,'ship',self._startX-0.5,self._startY-0.5,self._startX+0.5,self._startY+0.5).render()
...
class Icon(object):
	...
	def render(self):
		...
		outerSVG = genHTMLElement('svg',
					['id','x','y','height','width','visibility'],
					[self._htmlId,self._x,self._y,self._width,self._height,visibility],
					icon)
	...
	def _explosion(self):
		...
		partA = genHTMLElement('path',
								...
								c0.4-4.7,1.9-8.4,1.5-13.4c-5.3,2-9.4,5.2-13.6,8.3c-2.1-3-3.7-6.4-5.6-9.5c-4.9,1.4-5.6,7-9.7,9.3C26,5.8,22.2,3.7,20,0h-1.2\
								c-2,3.3-1.7,8.8-3.9,11.9c-3.8-0.5-9.4-2.3-11.9,0c1.8,3.9,3.5,7.8,5.6,11.5c-2.7,2.7-7.2,3.5-8.5,7.5c3.5,2.1,8.9,1.9,11.7,4.1\
								c-1.3,3.7-3,8.3-3.9,12.2C7.6,48,8.2,48.6,7.3,49c5.5,0.3,10-2.3,14.1-4.1c1.5,3.6,1.6,8.4,3.9,11.2c3.3-1.9,4.7-5.7,7.8-7.8\
								c3,1.8,6.3,3.3,8.5,5.8c1.7,0.2,2.3,2.5,4.4,1.5c0.7-3.7,0.7-8.5,1.2-12.7c4.7,0.7,10.3,2.7,14.9,2c0.1-4.1-3.6-6.4-4.9-10\
								C60.9,33.5,65.5,33,69.4,31.9z M59.2,43.1c-3.6,0.2-11.7-4.3-14.4-1.5c1,2.9-0.3,7,0,11c-4-2.2-7.1-5.2-11.9-6.6\
								c-2.9,1.8-3.9,5.5-7.1,7.1c-0.9-4.3-2.1-7.6-3.2-10.7c-4.1,1.7-8.1,3.4-12.9,4.4c0.8-4.7,3.3-9.1,3.7-13.4c-2.4-1.6-7.1-2.3-11-3.2\
								c2.5-2.5,5.7-4.2,8.3-6.6c-1.9-3.3-3.6-6.8-5.4-10.2c3.5-0.7,8,1.2,11,1c1.8-2.9,1.7-7.6,2.9-11c3,1,5.5,7.7,9.3,7.3\
								c2.3-0.3,6.1-7.8,8.3-9c0.4-0.1,0.4,0.2,0.7,0.3c0.9,4.1,3.3,6.8,5.4,9.7c1.7,0.4,2.3-1.4,3.2-2.2c1-0.9,2.5-1.8,3.9-2.7\
								c2-1.3,3.3-2.5,5.9-3.4c0.1,4-1.1,8.8-1.7,12.9c0.1,0.3,0.4,0.4,0.5,0.7c3.9-1.1,8.2,0,11.7-0.5c-0.6,3.1-4.3,5.3-5.6,8.5\
								c1.5,2.3,3.8,3.7,5.1,6.1c-3.5,0.9-7.6,1.2-10.7,2.9C55.3,37.2,58.1,40,59.2,43.1z'])
		partB = genHTMLElement('path',
								['class','d'],
								['st1_explosion','M53.6,25.3c0.2-3,3.5-3,5.1-4.6C56.9,17.9,52,21.3,48,20c0.6-3.1,3.1-5.5,2.7-8.8\
								c-4.2,0.9-7.6,4.7-11.9,6.3c-0.7-3-2.3-5.7-2.4-8.5c-3.7,1-4.1,5.3-7.1,7.1c-2.4-2-5.3-3.5-8.3-4.9c-1.4,1.6-0.5,5.7-1.9,7.3\
								c-2.4,0-5.9-1.4-6.8,1.5c0.5,2.4,2,3.8,2.9,5.8c-1.3,1.3-3.6,1.8-4.4,3.6c2.1,1.4,5.9,1.1,7.1,3.4c-0.1,3.1-2.2,6.2-1.2,8.8\
								c3.6-0.4,5.5-2.6,8.8-3.4c0.6,2.3,1.5,4.3,2,6.8c3.8,0.9,4-3.7,6.8-4.6c2.8,0.6,3.7,3,6.6,3.4c2.1-1,0.7-5.5,2.4-6.8\
								c3.1-0.3,6.9,2.1,10,1.5c0-0.6,0.4-0.8,0.7-1.2c-0.8-2-2.2-3.3-2.4-5.9c2-1.3,5.3-1.4,6.8-3.2C57.1,26.9,55.3,26.1,53.6,25.3z\
								 M49.7,30.9c0,2.1,1,3.3,1.2,5.1c-2.7,0.5-5.2-1.1-8.5-0.7c-1.8,0.8-1.3,3.8-2.4,5.4c-2.1-0.5-3.4-1.7-5.3-2.2\
								c-2.9,0.5-3.1,3.7-5.9,4.4c-0.5-3.2-1.8-4.6-2.2-6.8c-3,0.8-5.3,3.5-8.5,3.4c0.9-2.3,1.1-5.2,1.2-8.3c-0.9-1.2-2.6-1.6-4.1-2.2\
								c0.2-1.9,2-1.2,2.2-2.7c0.3-2.1-3.1-3.4-2.9-6.1c2.6-0.1,3.8,0.6,6.1,0c0.9-2,0.3-4.1,1-6.3c2.9,0.9,5,2.6,7.3,4.1\
								c2.8-1.1,4-3.8,5.9-5.8c2.3,1.2,1.4,5.5,3.4,6.8c3.7-1.5,7.4-4.3,10.7-5.3c0,2.1-1.6,4.5-2,7.1c2.4,2.3,6.3-0.1,8.5,0.5\
								c-1.1,2-4.5,3-4.1,5.6c0.9,0.4,3.3,0.1,3.4,1.9C53.8,30.3,51.1,30,49.7,30.9z'])
